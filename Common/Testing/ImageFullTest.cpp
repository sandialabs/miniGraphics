...
template <typename ImageType>
std::unique_ptr<ImageType> createColorDepthImage1(int regionBegin,
                                                  int regionEnd) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createColorOnlyImage1(int regionBegin,
                                                 int regionEnd) {
  std::unique_ptr<ImageType> image(
      new ImageType(IMAGE_WIDTH, IMAGE_HEIGHT, regionBegin, regionEnd));
  image->clear();
...
template <typename ImageType>
std::unique_ptr<ImageType> createImage1Impl(int regionBegin,
                                            int regionEnd,
                                            std::true_type) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createImage1(int regionBegin = 0,
...
template <typename ImageType>
std::unique_ptr<ImageType> createColorDepthImage2(int regionBegin,
                                                  int regionEnd) {
  std::unique_ptr<ImageType> image(
      new ImageType(IMAGE_WIDTH, IMAGE_HEIGHT, regionBegin, regionEnd));
  image->clear();
...
template <typename ImageType>
std::unique_ptr<ImageType> createColorOnlyImage2(int regionBegin,
                                                 int regionEnd) {
  std::unique_ptr<ImageType> image(
      new ImageType(IMAGE_WIDTH, IMAGE_HEIGHT, regionBegin, regionEnd));
  image->clear();
...
template <typename ImageType>
std::unique_ptr<ImageType> createImage2Impl(int regionBegin,
                                            int regionEnd,
                                            std::true_type) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createImage2(int regionBegin = 0,
                                        int regionEnd = IMAGE_WIDTH *
                                                        IMAGE_HEIGHT) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createColorDepthImageCombined(int regionBegin,
                                                  int regionEnd) {
  std::unique_ptr<ImageType> image(
      new ImageType(IMAGE_WIDTH, IMAGE_HEIGHT, regionBegin, regionEnd));
  image->clear();
  ...
  for (int pixelIndex = regionBegin; pixelIndex < regionEnd; ++pixelIndex) {
    ...
    if ((x > BORDER) && (x < IMAGE_WIDTH - BORDER) && (y > BORDER) &&
      ...
      if ((x <= y) &&
          (x > (IMAGE_HEIGHT -y) || (x < (IMAGE_WIDTH / 2)))) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createColorOnlyImageCombined(int regionBegin,
                                                 int regionEnd) {
  std::unique_ptr<ImageType> image(
      new ImageType(IMAGE_WIDTH, IMAGE_HEIGHT, regionBegin, regionEnd));
  image->clear();
...
template <typename ImageType>
std::unique_ptr<ImageType> createImageCombinedImpl(int regionBegin,
                                            int regionEnd,
                                            std::true_type) {
...
template <typename ImageType>
std::unique_ptr<ImageType> createImageCombined(int regionBegin = 0,
                                        int regionEnd = IMAGE_WIDTH *
                                                        IMAGE_HEIGHT) {
